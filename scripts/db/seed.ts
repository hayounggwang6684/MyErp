...
async function seed() {
  ...
  const employees = [
    ...
    },
    {
      ...
      department: "영업부",
      jobTitle: "거래처 담당",
      contact: "010-1000-1101",
      workStatus: "거래처 등록 테스트",
      assignedWorkCount: 2,
    },
    {
      id: "emp_006",
      ...
      department: "영업부",
      jobTitle: "수주 담당",
      contact: "010-1000-1201",
      workStatus: "수주 등록 테스트",
      assignedWorkCount: 3,
    },
    {
      id: "emp_007",
  ...
  const users = [
    ...
    },
    {
      ...
      employeeId: "emp_005",
      username: "customer.ha",
      password: "1234",
      name: "고객관리 테스트",
      department: "영업부",
      roles: ["CUSTOMER_MANAGE"],
    },
    {
      id: "usr_test_order_001",
      employeeId: "emp_006",
      username: "order.ha",
      password: "1234",
      name: "수주관리 테스트",
      department: "영업부",
      roles: ["ORDER_MANAGE", "PARTS_SALES"],
    },
    {
      id: "usr_test_work_001",
      employeeId: "emp_007",
      username: "work.ha",
      password: "1234",
      name: "작업관리 테스트",
    ...
    {
      id: "usr_test_inventory_001",
      employeeId: "emp_008",
      username: "inventory.ha",
      password: "1234",
      name: "재고관리 테스트",
      department: "자재부",
    ...
    },
    {
      ...
      name: "전체권한 테스트",
      department: "영업부",
      roles: ["CUSTOMER_MANAGE", "ORDER_MANAGE", "PARTS_SALES", "WORK_MANAGE", "INVENTORY_VIEW", "STAFF_VIEW"],
    },
  ];
