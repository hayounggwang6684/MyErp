...
contextBridge.exposeInMainWorld("erpClient", {
  ...
  mergeCustomers: (payload) => ipcRenderer.invoke("customers:merge", payload),
  ...
  restoreAssetEquipment: (equipmentId) => ipcRenderer.invoke("customers:restore-equipment", equipmentId),
  ...
  upsertEquipmentOption: (payload) => ipcRenderer.invoke("customers:upsert-equipment-option", payload),
  deactivateEquipmentOption: (payload) => ipcRenderer.invoke("customers:deactivate-equipment-option", payload),
  mergeEquipmentOption: (payload) => ipcRenderer.invoke("customers:merge-equipment-option", payload),
