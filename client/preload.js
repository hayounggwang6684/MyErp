...
contextBridge.exposeInMainWorld("erpClient", {
  ...
  listAdminUsers: () => ipcRenderer.invoke("admin:users:list"),
  unlockAdminUser: (userId) => ipcRenderer.invoke("admin:users:unlock", userId),
  resetAdminUserMfa: (userId) => ipcRenderer.invoke("admin:users:reset-mfa", userId),
